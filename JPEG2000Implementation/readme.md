...
3. Entropy coding: After partitioning the data array into different blocks, we apply entropy coding to each of the blocks in parallel.
...
Entropy Coding:
Import entropy_parallel.py and call 
<!-- not done yet -->